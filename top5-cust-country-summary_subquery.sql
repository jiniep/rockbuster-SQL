...
SELECT top5customers.country, 
	all_customers_count, 
	COUNT(top5customers.customer_id) AS top_customer_count
FROM 
	(	-- count customers in all countries
		SELECT c2.country_id, COUNT(DISTINCT c.customer_id) as all_customers_count
		FROM customer c
...
JOIN (
	...
	SELECT 
		...
		WHERE c2.country IN ('India', 'China','United States','Japan',
	...
	GROUP by top5customers.country, all_customers_count
